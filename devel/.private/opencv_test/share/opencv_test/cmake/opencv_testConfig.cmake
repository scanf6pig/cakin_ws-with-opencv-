...
if("TRUE" STREQUAL "TRUE")
  set(opencv_test_SOURCE_PREFIX /home/lin/catkin_ws/src/opencv_test)
  set(opencv_test_DEVEL_PREFIX /home/lin/catkin_ws/devel/.private/opencv_test)
  ...
  set(opencv_test_INSTALL_PREFIX /home/lin/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'opencv_test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lin/catkin_ws/src/opencv_test/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lin/catkin_ws/devel/.private/opencv_test/lib;/home/lin/catkin_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(opencv_test_EXPORTED_TARGETS ${${opencv_test_dep}_EXPORTED_TARGETS})
endforeach()
